...
/**
	* This program tries to open a given path file, and throws errors if the path is not valid
	* It also logs the actual error trace to a log file, using the Go built-in Log package
**/
